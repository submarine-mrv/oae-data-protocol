...
Currently, the OAE Data Schema aligns with:
...
- **[CF Conventions](https://cfconventions.org/)** — Our recommended column header names and observation types draw from CF standard names and discrete sampling geometry conventions.
- **[science-on-schema.org](https://science-on-schema.org/)** — Our schema maps to schema.org where applicable, supporting dataset discovery through standard web metadata.
